...
impl<'t, 'p: 't> TcCtx<'t, 'p> {
    ...
    pub fn inst(&mut self, e: ExprPtr<'t>, substs: &[ExprPtr<'t>]) -> ExprPtr<'t> {
        crate::util::clear_or_shrink(&mut self.expr_cache.inst_cache);
    ...
    pub fn abstr_levels(&mut self, e: ExprPtr<'t>, start_pos: u32) -> ExprPtr<'t> {
        crate::util::clear_or_shrink(&mut self.expr_cache.abstr_cache_levels);
    ...
    pub fn abstr(&mut self, e: ExprPtr<'t>, locals: &[ExprPtr<'t>]) -> ExprPtr<'t> {
        crate::util::clear_or_shrink(&mut self.expr_cache.abstr_cache);
    ...
    pub fn subst_expr_levels(&mut self, e: ExprPtr<'t>, ks: LevelsPtr<'t>, vs: LevelsPtr<'t>) -> ExprPtr<'t> {
        ...
        crate::util::clear_or_shrink(&mut self.expr_cache.subst_cache);
