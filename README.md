...
The value representation, the conversion algorithm, and the fast path of the export parser come from [sokonanoda](https://github.com/intgrah/sokonanoda) (Apache-2.0), whose normalisation by evaluation follows [smalltt](https://github.com/AndrasKovacs/smalltt). The closure machinery above is nanoclo's own.
